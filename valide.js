...
const ATTENDU = {
  equipe: 'CHICAGO',
  taille: 22,
  echantillon: {nom: 'Tim Stutzle', salaire: 5325000, ct: 1, ov: 79},
  masseSousContrat: 36675000,
  nbSousContrat: 8,
  dateSecours: '1er août 2026',
  nbEchus: 14,
  nbBackups: 0,
  masseTotale: 83125000
};
...
(async () => {
  ...
  W.localStorage.removeItem('chi_resignatures_v1');
  W.localStorage.removeItem('chi_transac_v1');
